...
- spimemio
    ...
    Added DSPI recovery and extra delay cycles for $t_{RES1} of Winbond,
    GigaDevice, and Puya SPI flash. QSPI function disabled as TangNano-9K
    only supports DSPI operation.
...
manually pressing and releasing the reset button (**S1**) after
prompted by the flasher.
